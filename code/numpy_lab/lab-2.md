...
![Гистограмма распределения оценок по математике](./plots/histogram.png "Гистограмма оценок по математике")

![Тепловая карта кореляции предметов](./plots/heatmap.png "Тепловая карта кореляции оценок")

![Линейный график зависимости оценки студента от его номера](./plots/line.png "Линейный график студент -> оценка")
...
![Гистограмма распределения оценок по математике](./plots/test_histogram.png "Гистограмма оценок по математике")

![Тепловая карта кореляции оценок](./plots/test_heatmap.png "Тепловая карта кореляции оценок")

![Линейный график зависимости оценки студента от его номера](./plots/test_line.png "Линейный график студент -> оценка")
